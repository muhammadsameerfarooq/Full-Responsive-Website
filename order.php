    ...
    <div class="container">
        <div class="row mt-5 pt-5">
            ...
            <div class="col-md-5">
                ...
                <p class="text-muted">Your orders in one place.</p>
            ...
            <div class="col-md-2">
                ...
                <a href=order.php class="text-muted">/ Orders</a>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            <th scope="row"><strong>#1735</strong></th>
                            <td>22/6/2017</td>
                            <td>$150.00</td>
                            <td><span class="badge bg-info">Being prepared</span></td>
                            <td><a class="btn btn-primary btn-sm" href="order-no.php">View</a></td>
                        </tr>
                        <tr>
                            <th scope="row"><strong>#1734</strong></th>
                            <td>7/5/2017</td>
                            <td>$150.00</td>
                            <td><span class="badge bg-warning">Action Needed</span></td>
                            <td><a class="btn btn-primary btn-sm" href="order-no.php">View</a></td>
                        </tr>
                        <tr>
                            <th scope="row"><strong>#1730</strong></th>
                            <td>30/9/2016</td>
                            <td>$150.00</td>
                            <td><span class="badge bg-success">Recieved</span></td>
                            <td><a class="btn btn-primary btn-sm" href="order-no.php">View</a></td>
                        </tr>
                        <tr>
                            <th scope="row"><strong>#1705</strong></th>
                            <td>22/6/2016</td>
                            <td>$150.00</td>
