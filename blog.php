...
<body>
    ...
    <div class="container">
        <div class="row mt-5 pt-5">
            ...
            <div class="col-md-2">
                ...
                <a href=blog.php class="text-muted">/ Blog</a>
            </div>
        </div>
    </div>
    ...
    <div class="container mt-5 pt-5">
        <div class="row">
            ...
            <div class="col-md-2">
                <img src="./images/books.jpg" class="image2">
            </div>

            <div class="col-md-3">
                <h3 class="hovers">Best Books about Fashion</h3>
                <h6 class="text-muted"><i class="bi bi-clock-fill"></i> May 10th 2016</h6>
                <br>
                <p class="text-muted">ellentesque habitant morbi tristique senectus<br>et netus et malesuada fames ac
                    turpis<br>egestas. Vestibulum tortor quam, feugiat<br>vitae, ultricies eget, tempor sit amet,
            ...
            <div class="col-md-2">
                <img src="./images/key.jpg" class="image2">
            </div>

            <div class="col-md-3">
                <h3 class="hovers">Autumn fashio tips and tricks</h3>
                <h6 class="text-muted"><i class="bi bi-clock-fill"></i> May 10th 2016</h6>
                <br>
                <p class="text-muted">Vestibulum tortor quam, feugiat vitae, ultricies<br>eget, tempor sit amet, ante.
                    Mauris placerat<br>eleifend leo.</p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-2">
                <a href="#tert"><button>Older Posts</button></a>
            </div>
            <div class="col-md-2"></div>
            <div class="col-md-2"></div>
            <div class="col-md-2"></div>
