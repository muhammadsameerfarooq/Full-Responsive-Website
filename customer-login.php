...
<body>
    ...
    <div class="container">
        <div class="row mt-5 pt-5">
            ...
            <div class="col-md-5">
                <h1><strong>Customer Zone</strong></h1>
            ...
            <div class="col-md-2">
                ...
                <a href=customer-login.php class="text-muted">/ Customer Zone</a>
            </div>
        </div>
    </div>
    ...
    <div class="container mt-5 pt-5">
        <div class="row">
            <div class="col-md-6">
                ...
                <label for="inputPassword" class="col-sm-2 col-form-label text-muted">Password</label>
                <input type="password" class="form-control" id="inputPassword">
                <br>
                <a class="btn btn-primary" href="order.php" role="button">Login</a>
            </div>
            <div class="col-md-6">
                <h5><strong>New account</strong></h5>
                <p>Not our registered customer yet?</p>
                <p class="text-muted">With registration with us new world of fashion, fantastic discounts and much more opens to you! The whole process will not take you more than a minute!

                    If you have any questions, please feel free to contact us, our customer service center is working for you 24/7.</p>
                <hr>
                <label for="exampleFormControlInput2" class="form-label text-muted">Name</label>
                ...
                <input type="password" class="form-control" id="inputPassword">
                <br>
                <a class="btn btn-primary" href="order.php" role="button">Register</a>
            </div>
        </div>
    </div>
