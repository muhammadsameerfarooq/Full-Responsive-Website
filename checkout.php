    ...
    <div class="container">
        <div class="row mt-5 pt-5">
            ...
            <div class="col-md-2">
                ...
                <a href=checkout.php class="text-muted">/ Checkout</a>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row mt-5 pt-5">
            ...
            <div class="col-md-6">
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    <a class="nav-link active" aria-current="page" href="checkout.php">ADDRESS</a>
                                </li>
                                <li class="nav-item">
                ...
                <br>
                <a class="btn btn-primary" href="shopping-cart.php" role="button">Back To Basket</a>

                <a class="btn btn-primary" href="checkout1.php" role="button">Choose Delivery Method</a>
