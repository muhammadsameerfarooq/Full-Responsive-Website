...
<head>
    ...
    <title>Your Order_No Page</title>
    ...
    <div class="container">
        <div class="row mt-5 pt-5">
            ...
            <div class="col-md-5">
                ...
                <p>Order # was placed on<strong> 22/06/2013</strong> and is currently<strong> Being prepared.</strong></p>
            ...
            <div class="col-md-2">
                ...
                <a href=order.php class="text-muted">/ order</a>
                <a href=order-no.php class="text-muted">/ order#</a>
            </div>
        </div>
    </div>
