    ...
    <div class="container">
        <div class="row mt-5 pt-5">
            ...
            <div class="col-md-2">
                ...
                <a href=checkout3.php class="text-muted">/ Checkout</a>
            </div>
        </div>
    </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="checkout3.php" tabindex="-1" aria-disabled="true">ORDER REVIEW</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td class="text-primary"><strong>$400</strong></td>
                        </tr>

                    </tbody>
                </table>
                <br>
                <a class="btn btn-primary" href="checkout2.php" role="button">Back To Payment method</a>

                <a class="btn btn-primary" href="checkout4.php" role="button">Place an order</a>
