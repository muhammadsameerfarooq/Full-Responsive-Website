    ...
    <div class="container">
        <div class="row mt-5 pt-5">
            ...
            <div class="col-md-2">
                ...
                <a href=profile.php class="text-muted">/ Your Profile</a>
            </div>
        </div>
    </div>
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <label for="inputPassword" class="col-sm-2 col-form-label text-muted">Old Password</label>
                <input type="password" class="form-control" id="inputPassword">

                <label for="inputPassword" class="col-sm-2 col-form-label text-muted">New Password</label>
                <input type="password" class="form-control" id="inputPassword">

                <label for="inputPassword" class="col-sm-2 col-form-label text-muted">Re-Type Password</label>
                <input type="password" class="form-control" id="inputPassword">
                <br>
                <a class="btn btn-primary" href="order.php" role="button">Change Password</a>
            </div>
        </div>
    </div>
